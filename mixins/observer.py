...
class Observer():
    ...
    """
    def _set_broadcast_data(self, signal_name: str, sender: BaseWidget, args: list) -> None:
        """
    ...
    def _set_listener_data(self, signal_name: str, listener: BaseWidget, func: Callable) -> None:
        """
    ...
    def obs_broadcast(self, signal_name: str, sender: BaseWidget, args: list[Any] = []) -> None:
        """
    ...
    def obs_listen(self, signal_name: str, listener: BaseWidget, func: Callable) -> None:
        """
        A function from the Observer mixin.
